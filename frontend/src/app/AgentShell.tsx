...
export interface AgentShellProps {
  ...
  onRewind: (conversationId: string, messageId: string) => Promise<{ content: string; sessionId: string; sourceNodeId?: string; sourceNodeSessionId?: string; branch?: boolean } | undefined>;
