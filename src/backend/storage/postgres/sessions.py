"""PostgreSQL adapter for durable conversations and runtime snapshots."""
...
class PostgresSessionStore(PostgresSchemaMixin, SessionMappingMixin):
    ...
    def save(self, runtime, reason: str) -> None:
        """Atomically persist a session snapshot, checkpoint, and audit messages."""
