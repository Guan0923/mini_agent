    ...
    *,
    ...
    return (
        ...
        Tool(
            "web_fetch",
            (
                "Fetches readable Markdown or text content from a public web URL.\n\n"
                "- Supports structured Markdown from HTML pages, plain text, and formatted JSON responses.\n"
                "- Automatically follows up to 3 redirects. DNS validation is pinned to each actual connection.\n"
                "- The untrusted body is limited to max_chars, including any truncation notice.\n"
            ...
            _object_schema(
                {
                    ...
                    "max_chars": {
                        ...
                        "maximum": 100_000,
                        "default": 50_000,
                        "description": "Maximum characters in the untrusted fetched body.",
                    },
                },
                ["url"],
            ),
