...
class AgentThreadIndex:
    ...
    def __init__(self) -> None:
        ...
        self.path_threads: dict[tuple[str, str], str] = {}
    ...
    def refresh_session(self, store: object, session_id: str) -> None:
        ...
        with self._lock:
            ...
            for thread_id in stale:
                ...
                if path is not None:
                    self.path_threads.pop((session_id, path), None)
    ...
    def _add(self, runtime_threads: list[RuntimeThread], thread_nodes: list[ThreadNode]) -> None:
        ...
        for node in thread_nodes:
            self.path_threads[(node.session_id, node.thread_path)] = node.thread_id
    ...
    def thread_for_path(self, session_id: str, thread_path: str) -> str | None:
        with self._lock:
            return self.path_threads.get((session_id, thread_path))
